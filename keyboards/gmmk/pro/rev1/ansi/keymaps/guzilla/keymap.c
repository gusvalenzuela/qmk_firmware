...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_FN1] = LAYOUT(
        ...
        _______, G(KC_1), G(KC_2), G(KC_3), G(KC_4), G(KC_5), G(KC_6), G(KC_7), G(KC_8), G(KC_9), G(KC_0), _______, KC_SEC6, _______,          SWIN(KC_S),
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        ...
        _______, KC_WINLCK, _______,                          _______,                            _______, _______, _______, SWIN(KC_LEFT), _______, SWIN(KC_RGHT)
    ),
   ...
   [NO_KEYS] = LAYOUT(
    ...
    [FUNCTIONS] = LAYOUT(
        _______, KC_RGBH, KC_RGBS, KC_RGBV, KC_RGBE, KC_RGBP, KC_WRGB, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT,  C(A(KC_DEL)),    _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
    ...
    [SECRETS] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_RST,
        _______, _______, KC_SEC1, _______, _______, _______, _______, _______, _______, KC_SEC5, KC_SEC4, KC_SEC3, _______, _______,          _______,
        _______, _______, KC_SEC2, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
        _______, _______, _______,                            _______,                            _______, _______, _______, _______, _______, _______
    ),
};
...
const ledmap PROGMEM ledmaps[] = {
    ...
    [SECRETS] = RGB_MATRIX_LAYOUT_LEDMAP(
         ...
         GOLD,    ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______,            RED,    GOLD,
